// ============================================ // PROJETO: CASA DO NORTE TIA RITINHA // STACK: React + Tailwind + Vercel // ============================================ // // ESTRUTURA DO PROJETO: // // /src //   /components //   /pages //   App.jsx //   main.jsx // // ARQUIVOS NECESSÁRIOS: // // package.json // vite.config.js // tailwind.config.js // postcss.config.js // index.html // // INSTALAÇÃO: // npm install // npm run dev // // BUILD: // npm run build // // DEPLOY: // conectar GitHub na Vercel // ============================================

export default function CasaDoNorteSite() { const deliveryRules = { freeUntilKm: 2, pricePerKm: 2, scheduledAboveKm: 3, minimumOrderAbove3Km: 50, }

const featuredFreeDeliveryProducts = [ 'Frango Assado', 'Galão de Água 20L', ]

return ( <div className="min-h-screen bg-[#f6f1e7] text-[#3b2a1f] font-sans"> {/* DELIVERY INFO BAR */ <section className="bg-[#8b5e34] text-white py-4 px-6 text-center text-sm md:text-base font-medium"> <p> 🚚 Entrega grátis até 2km • Acima disso R$ 2,00 por km • Acima de 3km apenas pedidos acima de R$ 50 com entrega agendada. </p> </section>
